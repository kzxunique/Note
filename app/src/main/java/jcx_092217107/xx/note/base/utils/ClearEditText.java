...
public class ClearEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    public interface OnEditTextClearListener {
        public void onEditTextClear(ClearEditText v);
    }
    ...
    private OnEditTextClearListener mOnEditTextClearListener;
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.drawable.cs_chacha_hui);
        }
//        mClearDrawable.setBounds(0, 0, mClearDrawable.getIntrinsicWidth(), mClearDrawable.getIntrinsicHeight());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (getCompoundDrawables()[2] != null) {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (touchable) {
                    this.setText("");
                    if (mOnEditTextClearListener != null) {
                        mOnEditTextClearListener.onEditTextClear(this);
                    }
                }
            }
        }
    ...
    public void setOnEditTextClearListener(OnEditTextClearListener onEditTextClearListener) {
        mOnEditTextClearListener = onEditTextClearListener;
    }
...
//    public void isChaCha(boolean click) {
//
//    }
