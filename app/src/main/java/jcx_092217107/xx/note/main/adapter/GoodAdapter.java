...
public class GoodAdapter extends BaseQuickAdapter<GoodBean, BaseViewHolder> {
    public GoodAdapter(int layoutResId, @Nullable List<GoodBean> data) {
    ...
    protected void convert(BaseViewHolder helper, GoodBean item) {
        ...
        helper.addOnClickListener(R.id.re_go_xg);
